...
export function FinalCta() {
  return (
    <section id="pricing" className="relative mx-auto max-w-6xl overflow-hidden border-t border-white/[0.06] px-6 py-28 text-center">
      <div className="relative z-10 mx-auto max-w-3xl">
        <FadeIn>
          ...
          <Button asChild size="lg" className="inline-flex shadow-[0_0_30px_rgba(109,94,245,0.4)] hover:shadow-[0_0_40px_rgba(109,94,245,0.6)]">
            <a href="#">
